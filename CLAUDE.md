...
Colophon is a self-hosted e-book metadata manager. Flask + Gunicorn + SQLite, running in Docker. Single-user, hobby project. Version 1.34.0.
...
**Known pre-existing failures (as of v1.34.0):** a clean run is *447 passed, 10
