...
Colophon is a self-hosted e-book metadata manager. Flask + Gunicorn + SQLite, running in Docker. Single-user, hobby project. Version 1.33.0.
...
**Known pre-existing failures (as of v1.33.0):** a clean run is *447 passed, 10
