...
`:latest` follows the main branch. Prefer pinned releases? Use a version tag instead, e.g. `ghcr.io/cgillinger/colophon:1.46.2` — every [release](https://github.com/cgillinger/colophon/releases) gets a matching image tag.
