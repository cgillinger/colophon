...
_API_TOGGLE_KEYS = [
    ...
    "METADATA_SOURCE_LIBRIS_ENABLED",
    "METADATA_SOURCE_OPENLIBRARY_ENABLED",
...
def _settings_view_context():
    ...
    return {
        ...
        "source_libris_enabled": (get_setting("METADATA_SOURCE_LIBRIS_ENABLED", "true") or "true").lower() == "true",
        "source_openlibrary_enabled": (get_setting("METADATA_SOURCE_OPENLIBRARY_ENABLED", "true") or "true").lower() == "true",
